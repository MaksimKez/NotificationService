...
public class OperationRegistry : IOperationRegistry
{
    ...
    public bool TryGetPacketType(int operationId, out Type? packetType) => _opToType.TryGetValue(operationId, out packetType);


    public bool TryGetOperationId(Type packetType, out int operationId) => _typeToOp.TryGetValue(packetType, out operationId);
}